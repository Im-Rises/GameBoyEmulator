...
private:
	...
	const normalOpcodesArray[256] = {	//Normal ocpodes
	...
	const doubleOpcodesArray[256] = {	//Opcodes following a CB opcode
...
private:
	...
	void opcodeOperation_LD(uint8_t& register1, uint8_t& register2);
